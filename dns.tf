...
#   provider = aws.region-master
#   for_each = {
#     for val in aws_acm_certificate.jenkins_lb_https_cert.domain_validation_options : val.domain_name => {
...
#   type     = "A"
#   alias {
#     name                   = aws_lb.jenkins_master_app_loadbalancer.dns_name
#     zone_id                = aws_lb.jenkins_master_app_loadbalancer.zone_id
